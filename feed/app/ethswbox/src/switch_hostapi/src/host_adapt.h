...
/* This is to access Clause 22 for host <-> Switch communication.
 * Default access Clause 45.
 */
//#define ENABLE_CL22_EXTENSION	1
#define CL22_STD_MMDCTRL	13
#define CL22_STD_MMDDATA	14
